...
class RevisorController extends Controller
{
    public function dashboard(){
        $unrevisionedArticles = Article::with('user')->where('is_accepted', NULL)->get();
        $acceptedArticles = Article::with('user')->where('is_accepted', true)->get();
        $rejectedArticles = Article::with('user')->where('is_accepted', false)->get();
